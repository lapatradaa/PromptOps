...
export const FormStepOne: React.FC<FormStepOneProps> = ({ formData, updateFormField }) => {
    return (
                ...
                <div className={styles.radioGroupInline}>
                    <div className={styles.radioLabelInline}>
                        <input
                            ...
                            onChange={() => updateFormField('type', 'qa' as const)}
                    ...
                    <div className={styles.radioLabelInline}>
                        <input
                            ...
                            onChange={() => updateFormField('type', 'sentiment' as const)}
                            className={styles.radioInputInline}
                            required
                        />
