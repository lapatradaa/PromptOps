...
import { OverallScore } from "@/app/types";
...
const CircleChart: React.FC<OverallScoreProps> = ({ overallScore }) => {
    ...
    const centerTextPlugin: Plugin<ChartType> = {
        ...
        beforeDraw: (chart) => {
            ...
            const passRate = chart.data.datasets[0].data[0] as number;
            const failureRate = chart.data.datasets[0].data[1] as number;

            // Determine text color based on pass vs fail
            let textColor = "#999";
