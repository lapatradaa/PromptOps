...
#             else:
#                 set_openai_api_key()  # Fetch from env if not provided
...
#     def generate_completion(self, prompt, batch=False):
#         """
...
# completion = PromptCompletion(model_provider="openai", model="gpt-3.5-turbo", api_key=openai_key)
# response = completion.generate_completion("Tell me a story about a brave knight.")
# print(response)


# # Initialize with Claude as the provider
...
#     system_content="You will act as a knowledgeable assistant.",
#     temperature=0.7,
#     max_tokens=150,
#     stream=False,  # You can change this to True if you want streaming
#     llama_url="http://127.0.0.1:8000/v1/chat/completions"
# )

# response = completion.generate_completion(prompt="What is the capital of France?")
# print(response)


# Test for Llama with Chain of Thought
...
promptt = """Q: Rogers started with 5 balls. 2 cans of 3 tennis balls each is 6 tennis balls. 5+6=11. How many tennis balls does he have now?
"""

response = completion.generate_completion(prompt=promptt, chain_of_thought=True)
print(response)
