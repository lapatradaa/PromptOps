from PromptOps.cot_templates import COTShotTemplateFormatter

def process_and_save_csv(input_file, output_prefix):
    # Initialize the formatter with the input file
    formatter = COTShotTemplateFormatter(input_file)
    ...
    for perturb_type in perturbation_types:
        ...
        output_file = f"COT_few_{output_prefix}_{perturb_type}_output.csv"
